...
public class Helder extends SysLin {
        ...
        for (int i = 0; i < getOrdre(); i++) {
            ...
            for (int j = 0; j < i; j++) {
                ...
                for (int k = 0; k < j; k++) {
                    ...
                    // System.out.print(" + " + matriceSystem.getCoef(i, k) + " * " + matriceSystem.getCoef(k, k) + " * " + matriceSystem.getCoef(k, j));
                }
                // System.out.println(" = " + sum);
                // System.out.println("nouveaux coef : " + (matriceSystem.getCoef(i, j) + " - " + sum) + " / " + matriceSystem.getCoef(j, j) + " = " + (matriceSystem.getCoef(i, j) - sum) / matriceSystem.getCoef(j, j));
                // System.out.println("avant L" + i + j + " :");
            ...
            // System.out.println("avant D" + i + i + " :");
            // System.out.println(matriceSystem);
            ...
            for (int j = i + 1; j < getOrdre(); j++) {
                ...
                // System.out.println("avant R" + i + j + " :");
                // System.out.println(matriceSystem);
    ...
    public static void main(String[] args) throws IrregularSysLinException {
        ...
        Matrice matrice2 = new Matrice("src/Matrice.txt");
        Vecteur secondmembre2 = new Vecteur("src/vecteur.txt");
